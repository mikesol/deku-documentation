...
import * as RunningAffsWithCancellationInResponseToAnEvent from 'PureScript/Examples.RunningAffsWithCancellationInResponseToAnEvent/index.js'
...
import * as RunningAffsSequentiallyInResponseToAnEvent from 'PureScript/Examples.RunningAffsSequentiallyInResponseToAnEvent/index.js'
...
import * as RunningEffectsInResponseToEvents from 'PureScript/Examples.RunningEffectsInResponseToEvents/index.js'
...
import * as RunningAffsInResponseToAnEvent from 'PureScript/Examples.RunningAffsInResponseToAnEvent/index.js'
...
import * as PurityOutOfThinAir from 'PureScript/Examples.PurityOutOfThinAir/index.js'
...
toStart === 'UnMemoizedApplication'
  ...
  : toStart === 'UseRef'
  ? UseRef.main()
  : toStart === 'RunningAffsWithCancellationInResponseToAnEvent'
  ? RunningAffsWithCancellationInResponseToAnEvent.main()
  ...
  : toStart === 'UnsafePursx'
  ? UnsafePursx.main()
  : toStart === 'RunningAffsSequentiallyInResponseToAnEvent'
  ? RunningAffsSequentiallyInResponseToAnEvent.main()
  ...
  : toStart === 'UseDyn'
  ? UseDyn.main()
  : toStart === 'RunningEffectsInResponseToEvents'
  ? RunningEffectsInResponseToEvents.main()
  ...
  : toStart === 'CustomHook2'
  ? CustomHook2.main()
  : toStart === 'NestedCustomHooks'
  ? NestedCustomHooks.main()
  ...
  : toStart === 'MockDiscord'
  ? MockDiscord.main()
  : toStart === 'RunningAffsInResponseToAnEvent'
  ? RunningAffsInResponseToAnEvent.main()
  ...
  : toStart === 'PurityOutOfThinAir'
  ? PurityOutOfThinAir.main()
