...
foreign import useEffectHookURL :: String
...
examples = Examples {
 ...
 useEffectHook: useEffectHookURL,
...
exampleToString UseEffectHook = (unwrap examples).useEffectHook
...
exampleToSlug UseEffectHook = "UseEffectHook"
