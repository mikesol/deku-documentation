...
stateWithoutInitialValues = section
  ...
  , topmatter: pure
      [ D.p_
          [ text_ "It's possible to have a state hook without an initial value. In that case, whatever the hook was controlling, be it text, an attribute, or an element, is simply omitted from the DOM."
          ]
      ]
  , subsections:
