...
differencesWithTraditionalPolymorphism :: forall lock payload. Subsection lock payload
differencesWithTraditionalPolymorphism = subsection
    { title: "Differences with traditional polymorphism"
    , matter:
        [ D.p_
            [ text_ "This subsection will be about "
            , D.span (D.Class !:= "font-bold") [ text_ "Differences with traditional polymorphism"]
            , text_ "."
            ]
        ]
    }
