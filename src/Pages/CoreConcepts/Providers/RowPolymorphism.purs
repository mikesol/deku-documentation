...
rowPolymorphism = section
  ...
  , topmatter: pure
      ...
      , D.p_
          [ text_ "When writing a library, you won't have control over the types of the consuming application, and you'll want to make it as convenient as possible for consumers to integrate your library. In these cases, The Deku Way™, and dare I say The PureScript Way™, is to make liberal use of Row Polymorphism. This section is both a crash course in Row Polymorphism as well as some indications of how to use it as a Deku library builder."
          ]
      ]
  , subsections:
