...
typeSafety = subsection
  ...
  , matter: pure
      [ D.p_
          [ text_ "Going back to our HTML string, you'll see that it's actually not a "
            ,D.code__ "String"
...
main = runInBody ((Proxy :: Proxy
  ...
  with type
    ...
    "span"
"""
        , D.p_ [text_ "While the message could be better by identifying line numbers and whatnot (we're working on this...), it identifies the HTML tag mismatch that needs to be corrected. Once we correct it, the program compiles!"]
      ]
  }
