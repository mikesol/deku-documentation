...
triggeringACallbackFromAsynchronousCode :: forall lock payload. Subsection lock payload
triggeringACallbackFromAsynchronousCode = subsection
    { title: "Triggering a callback from asynchronous code"
    , matter:
        [ D.p_
            [ text_ "This subsection will be about "
            , D.span (D.Class !:= "font-bold") [ text_ "Triggering a callback from asynchronous code"]
            , text_ "."
            ]
        ]
    }
