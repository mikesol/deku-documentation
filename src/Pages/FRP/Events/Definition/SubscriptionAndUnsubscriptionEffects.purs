...
subscriptionAndUnsubscriptionEffects :: forall lock payload. Subsection lock payload
subscriptionAndUnsubscriptionEffects = subsection
    { title: "Subscription and unsubscription effects"
    , matter:
        [ D.p_
            [ text_ "This subsection will be about "
            , D.span (D.Class !:= "font-bold") [ text_ "Subscription and unsubscription effects"]
            , text_ "."
            ]
        ]
    }
