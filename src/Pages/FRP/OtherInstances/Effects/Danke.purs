  ...
  , matter: do
      ...
      pure
        [ D.p_
            ...
            , D.i__ "after"
            , text_
                " an event emits. The only way to do this is not to depend on the value of the event - you pass it along and then run the effect. It is called "
            , D.code__ "thankTheDriver"
            , text_
                " because we're tipping our hat to the driver (the subscription) after we jump off the bus (the event). Let the battle royale begin!"
            ]
        , psCode
