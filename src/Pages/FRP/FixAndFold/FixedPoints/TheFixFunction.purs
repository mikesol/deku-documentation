...
theFixFunction = subsection
  ...
  , matter: \(Env { routeLink }) ->
      [ D.p_
          ...
          , D.code__ "fix"
          , text_
              " with respect to events is to think of streams that feed into each other in the natural world. Imagine you're at a sunny, warm beach. You dig a little stream from the sand down into the ocean and create a small loop for the water to feed back into itself. Assuming that the water has enough force when it reaches the loop, some particles will go around, rejoin the stream, and even potentially go around again before they empty into the ocean."
          ]
      , D.p_
          [ text_
