...
samplingOnAnEvent = section
  ...
  , topmatter: pure
      [ D.p_
          [ text_
              "Before we look at effect systems, it's important to understand sampling in FRP. It's the mildest type of effect - one that messes with the temporality of events. It's also unlike other effect systems we'll see later down the line because we can accomplish these directly with combinators over "
          , D.code__ "Event"
          , text_ "and"
          , D.code__ "Poll"
          , text_
