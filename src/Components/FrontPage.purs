...
everything = fixed
              ...
              , D.button
                  ...
                  [ D.svg
                      ( oneOf
                          ...
                          , D.ViewBox !:= "0 0 16 16"
                          , D.Class !:=
                              "hidden h-4 w-4 fill-sky-400 [[data-theme=light]_&]:block"
                          ]
                      )
                      [ D.path
                          ( oneOf
              ...
              [ D.div (D.Class !:= "relative z-10 md:text-center lg:text-left")
                  ...
                  , D.div (D.Class !:= "relative")
                      [ D.p
                          ...
                          [ text_ "Never miss the cache again." ]
                      , D.p
                          ( D.Class !:=
  ...
  , D.div
      ...
      , D.div
          ...
          [ D.article_
              [ D.header (D.Class !:= "mb-9 space-y-1")
                  [ D.p
                      ( D.Class !:=
              ...
              , D.div
                  ...
                  , D.div
                      ...
                      , D.div (D.Class !:= "ml-4 flex-auto")
                          [ D.p
                              ...
                              [ text_ "Oh no! Something bad happened!" ]
                          , D.div
                              ( D.Class !:=
                  ...
                  , D.pre (D.Class !:= "prism-code language-js")
                      [ D.code_
                          [ D.span (D.Class !:= "token comment")
                              [ text_ "// cache-advance.config.js" ]
                          , D.span (D.Class !:= "token plain") []
                          , D.span (D.Class !:= "token plain") []
                          , D.span (D.Class !:= "token keyword module")
                              [ text_ "export" ]
                          , D.span (D.Class !:= "token plain") []
                          , D.span (D.Class !:= "token keyword module")
                              [ text_ "default" ]
                          , D.span (D.Class !:= "token plain") []
                          , D.span (D.Class !:= "token punctuation")
                              [ text_ "{" ]
                          , D.span (D.Class !:= "token plain") []
                          , D.span (D.Class !:= "token plain") []
                          , D.span
                              (D.Class !:= "token literal-property property")
                              [ text_ "strategy" ]
                          , D.span (D.Class !:= "token operator") [ text_ ":" ]
                          , D.span (D.Class !:= "token plain") []
                          , D.span (D.Class !:= "token string")
                              [ text_ "'predictive'" ]
                          , D.span (D.Class !:= "token punctuation")
                              [ text_ "," ]
                          , D.span (D.Class !:= "token plain") []
                          ...
                          , D.span (D.Class !:= "token operator") [ text_ ":" ]
                          , D.span (D.Class !:= "token plain") []
                          , D.span (D.Class !:= "token number") [ text_ "12" ]
                          , D.span (D.Class !:= "token punctuation")
                              [ text_ "," ]
                          , D.span (D.Class !:= "token plain") []
                          , D.span (D.Class !:= "token plain") []
