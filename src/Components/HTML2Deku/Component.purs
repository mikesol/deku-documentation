  ...
  D.div_
    [ D.div_
        ...
        , D.button
            ...
            , DA.klass_
                "ml-2 inline-flex items-center rounded-sm border border-transparent bg-indigo-600 px-2.5 py-1.5 text-xs font-medium text-white shadow-xs hover:bg-indigo-700 focus:outline-hidden focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
